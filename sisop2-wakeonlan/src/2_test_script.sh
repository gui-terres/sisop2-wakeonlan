...
monitor_logs() {
    gnome-terminal --geometry=100x30 -- bash -c "docker-compose logs -f participant1; exec bash"
    gnome-terminal --geometry=100x30 -- bash -c "docker-compose logs -f participant2; exec bash"
    gnome-terminal --geometry=100x30 -- bash -c "docker-compose logs -f participant3; exec bash"
    gnome-terminal --geometry=100x30 -- bash -c "docker-compose logs -f participant4; exec bash"
}
